...
* Support:
  ...
  For any position < n - 1,

  The probability is  $\frac{1}{n}$  for any value $[0, n)$ 

* For the last position.

  Any value  $[0, n)$ which is in the positon  $[0, n-1)$ , the probability is  $\frac{n-1}{n}$.

  I.e. Any value  $[0, n)$ which is in the last position. the probability is $ 1 - \frac{n-1}{n} = \frac{1}{n}.$
